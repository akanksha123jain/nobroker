...
public class ExpirationScheduler {
    ...
    public void checkExpiredSubscriptions() {
        List<OwnerPlans> activePlans = ownerPlansRepository.findBySubscriptionActiveTrueAndSubscriptionExpirationDateBefore(LocalDate.now());
...
//            if (plan.getSubscriptionExpiryDate().isBefore(today)) {
            ...
            ownerPlansRepository.save(plan);
        }
    }
}
//}
